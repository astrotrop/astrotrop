...
The \citetitle*{format-world} format provides a simple way of
...
The \citetitle*{gvid} (\cite{gvid}) system is a complex registry of metadata describing
...
In \citetitle*{dengler-2011} (\cite{dengler-2011}) the \cite{gvid} project team describe the system
...
\citetitle*{eml} (\cite{eml}) is a metadata specification
...
\begin{itemize}
\item \citetitle*{knb} {\cite{knb}} 
\item \citetitle*{gbif} {\cite{gbif}} 
\end{itemize}
...
http://www.geoplatform.gov/node/201/%26fq%3Dmetadata_type%3A%22geospatial%22%2BAND%2B
